              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4">
                  <span className="bannerIcon">
                     <a href="https://facebook.com/pratik_bavche_patil" target="_blank" rel="noopener noreferrer">
                    <FaFacebookF />
                     </a>
                  </span>
                  <span className="bannerIcon">
                  ...
                  <span className="bannerIcon">
                    <a href="https://instagram.com/pratik_bavche_patil" target="_blank" rel="noopener noreferrer">
                    <FaLinkedinIn />
                    </a>
                  </span>
                </div>
